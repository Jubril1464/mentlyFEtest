...
import { WalletTransaction } from "@/model/interface";
import Image from "next/image";

export const WalletTransactions = () => {
  return (
    <div className="col-span-3 bg-primary-1 p-5 rounded-2xl shadow-md">
      ...
      <div className="overflow-x-auto">
        <table className="w-full mt-5">
          <thead>
            <tr className="text-left text-[#AEABD8] text-sm font-karla font-normal">
          ...
          <tbody>
            {walletTransactions.map((transaction: WalletTransaction) => (
              <tr
                key={transaction.id}
                className="border-t border-[#2D2B4D] text-sm"
              >
